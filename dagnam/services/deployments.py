...
from dagnam._core._sse import SSEEvent, TERMINAL_DEPLOYMENT_EVENTS, iter_with_reconnect
...
def metrics(
    ...
    *,
    ...
    resolved = resolve_client(client, api_key, api_url)
    return resolved.get_deployment_metrics(
        _stringify_id(deployment_id), time_range=time_range
    )
...
def create(
    *,
    ...
    ...     name="my-dep", project_id="...", checkpoint_path="/ckpt.pt",
...
def pause(
    ...
    *,
    ...
    return _lifecycle_lro(
        resolved, dep_id, initial,
        success_states=_PAUSED_STATES, name="deployments.pause",
    )
...
def resume(
    ...
    *,
    ...
    return _lifecycle_lro(
        resolved, dep_id, initial,
        success_states=_ACTIVE_STATES, name="deployments.resume",
    )
...
def scale(
    ...
    *,
    ...
    return _lifecycle_lro(
        resolved, dep_id, initial,
        success_states=_ACTIVE_STATES, name="deployments.scale",
    )
...
def rollback(
    ...
    *,
    ...
    return _lifecycle_lro(
        resolved, dep_id, initial,
        success_states=_ACTIVE_STATES, name="deployments.rollback",
    )
