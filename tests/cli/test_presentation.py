...
def test_sanitize_terminal_text_is_the_core_sanitizer() -> None:
    from dagnam._core.text import sanitize_terminal_text as core_sanitize
    from dagnam.cli.presentation import sanitize_terminal_text

    assert sanitize_terminal_text is core_sanitize
