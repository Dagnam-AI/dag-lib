...
class TestCreatePytorchLoader:
    def test_train_loader(self, tmp_path):
        ...
        loader = create_pytorch_loader(
            ds, split="train", batch_size=16, num_workers=0,
            shuffle=True, val_ratio=0.1, test_ratio=0.1, seed=42,
        )
    ...
    def test_val_loader_no_drop_last(self, tmp_path):
        ds = _make_csv_dataset(tmp_path, class_names=["cat", "dog"])
        loader = create_pytorch_loader(
            ds, split="val", batch_size=8, num_workers=0,
            shuffle=False, val_ratio=0.1, test_ratio=0.1, seed=42,
        )
    ...
    def test_test_loader_no_drop_last(self, tmp_path):
        ds = _make_csv_dataset(tmp_path, class_names=["cat", "dog"])
        loader = create_pytorch_loader(
            ds, split="test", batch_size=8, num_workers=0,
            shuffle=False, val_ratio=0.1, test_ratio=0.1, seed=42,
        )
        assert loader.drop_last is False
    ...
    def test_pin_memory(self, tmp_path):
        ds = _make_csv_dataset(tmp_path, class_names=["cat", "dog"])
        loader = create_pytorch_loader(
            ds, split="train", batch_size=8, num_workers=0,
            shuffle=True, val_ratio=0.1, test_ratio=0.1, seed=42,
        )
    ...
    def test_deterministic_splits(self, tmp_path):
        ...
        loader1 = create_pytorch_loader(
            ds, split="train", batch_size=8, num_workers=0,
            shuffle=False, val_ratio=0.1, test_ratio=0.1, seed=99,
        )
    ...
    def test_split_sizes(self, tmp_path):
        ...
        train_loader = create_pytorch_loader(
            ds, split="train", batch_size=n, num_workers=0,
            shuffle=False, val_ratio=val_ratio, test_ratio=test_ratio, seed=42,
        )
        val_loader = create_pytorch_loader(
            ds, split="val", batch_size=n, num_workers=0,
            shuffle=False, val_ratio=val_ratio, test_ratio=test_ratio, seed=42,
        )
        test_loader = create_pytorch_loader(
            ds, split="test", batch_size=n, num_workers=0,
            shuffle=False, val_ratio=val_ratio, test_ratio=test_ratio, seed=42,
        )
